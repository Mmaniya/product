                    ...
                    <nav class="pcoded-navbar">
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="" >
                                    <a href="<?php echo PRODUCT_DIR ?>/index.php">
                                        <span class="pcoded-micon"><i class="feather icon-package"></i></span>
                                        <span class="pcoded-mtext">Products</span>
                                    </a>
                                    <!-- <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href="<?php echo PRODUCT_DIR ?>/index.php"><span class="pcoded-mtext">Add Products</span> </a>
                                        </li>
                                        <li class=" ">
                                            <a href="javascript:void(0);"><span class="pcoded-mtext">List Products</span> </a>
                                        </li>     
                                    </ul> -->
                                </li>                     
